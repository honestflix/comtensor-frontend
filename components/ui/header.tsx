...
import logo from '@/public/images/com-logo.png'
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link href="/" className="block" aria-label="Cruip">
              <Image src={logo} className='w-[75px] h-[75px]' alt="Cruip" width={250} height={250} />
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link href="/comtensor-list" className="text-gray-300 hover:text-gray-200 px-4 py-2 flex items-center transition duration-150 ease-in-out">
                  Comtensors
                </Link>
              </li>
              <li>
